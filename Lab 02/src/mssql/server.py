...
# ===========================================
# 3. TOOLS - Functions the client can call
# ===========================================
# Step 3.1: Define tool for getting table relationships
@mcp.tool()
def get_relationships(table_name: str) -> str:
    """Get foreign key relationships for a table.
    
    Args:
        table_name: The name of the table (e.g. 'schema.table' or just 'table')
    """
    return get_relationships_raw(table_name)

# Step 3.2: Define tool for describing table structure
@mcp.tool()
...
# Step 3.3: Define tool for executing SQL queries
@mcp.tool()
def execute_sql(query: str) -> str:
    """Execute a SQL query and return the results (read-only queries only).
...
# ===========================================
# 4. MAIN - Run the server
# ===========================================
# Step 4.1: Run server with stdio transport when executed directly
if __name__ == "__main__":
    # Best practice: Use stdio for subprocess communication
